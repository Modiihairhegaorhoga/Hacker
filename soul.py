...
TOKEN = '8119423303:AAFqAkYlyFQx3IZcc0vAZ4TgXYDjcgRld2w'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002408559466
CHANNEL_ID = -1002408559466
error_channel_id = -1002408559466
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @LDX_COBRA.*", parse_mode='Markdown')  # Contact owner message
            return
